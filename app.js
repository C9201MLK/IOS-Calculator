...
numbers.addEventListener("click", (e) => {
  ...
  if (e.target.className === "fas fa-plus" || e.target.className === "plus") {
    if (down.innerText === "" && up.innerText === "") {
      ...
      up.innerText =
        Number(up.innerText.split(" ")[0]) - Number(down.innerText) + " +";
      down.innerText = "";
  ...
  if (e.target.className === "fas fa-times" || e.target.className === "times") {
    if (down.innerText === "" && up.innerText === "") {
      ...
      up.innerText =
        Number(up.innerText.split(" ")[0]) - Number(down.innerText) + " x";
      down.innerText = "";
    } else if (up.innerText.includes("+")) {
      up.innerText =
        Number(up.innerText.split(" ")[0]) + Number(down.innerText) + " x";
  ...
  if (
    e.target.className === "fas fa-divide" ||
  ...
  if (
    e.target.className === "fas fa-equals" ||
